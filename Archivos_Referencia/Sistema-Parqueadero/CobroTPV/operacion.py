...
class Operacion:
    ...
    #Nota de Noe: Mover la conexión a otro archivo
    ...
    def abrir(self):
        conexion=pymysql.connect(host="localhost",
                                 ...
                                 database="db")
        #  S E R V I D O R
        # conexion=pymysql.connect(host="187.131.147.109",
        #                          user="Aurelio",
        #                          passwd="RG980320",
    ...
    #Nota de Noe: Poner esto en una clase
...
#Nota de Noe: De aqui en adelante poder otra clase
...
#### REPORTE DE CORTES A EXCEL ####
    ...
    #Nota de Noe: Mover esto a otra clase tambien
